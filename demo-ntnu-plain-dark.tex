...
\usetheme[slogan=english, mode=dark, style=plain,mathfont=serif]{NTNU}
%
% Edit your meta data here
%
	\title{\LaTeX{}-Beamer Style for NTNU}
	\subtitle{Demo of the  \texttt{plain} style dark mode}
...
\begin{document}
    ...
    \begin{frame}[fragile]{A slide in \texttt{plain} style}
        ...
        \lstinline!\usetheme[slogan=english, style=plain, mathfont=serif, mode=dark]{NTNU}!
