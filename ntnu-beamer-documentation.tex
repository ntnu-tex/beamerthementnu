...
\begin{document}
	...
	\begin{frame}[fragile]{Different styles}
		...
		The following 12 slides illustrate the three styles you can choose,
		first showing the title page and then a usual slide that also explains how to choose this style.

		Note that since \lstinline!slogan=english!, \lstinline!style=plain!, \lstinline!mathfont=sans!, and \lstinline!mode=light! are the defaults, if you use

		\lstinline!\usetheme{NTNU}!

		that is the same as

		\lstinline!\usetheme[slogan=english, style=plain, mathfont=sans, mode=light]{NTNU}!-
	\end{frame}
	{
		...
		\includepdf[pages={1,2}]{demo-ntnu-plain-dark.pdf}
		\includepdf[pages={1,2}]{demo-ntnu-horizontal-dark.pdf}
		\includepdf[pages={1,2}]{demo-ntnu-vertical-dark.pdf}
	}
	\section{Developer Guide}
		\begin{frame}[fragile]{Available options}
			...
			\begin{tabular}{lcl}
				...
				\lstinline!mode=light|dark! & \lstinline!light! & switch between a light and a dark color scheme\\
