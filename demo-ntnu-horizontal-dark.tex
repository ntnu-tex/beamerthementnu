...
\usetheme[slogan=norsk, style=horizontal, mode=dark]{NTNU}
%
% Edit your meta data here
%
	\title{\LaTeX{}-Beamer Style for NTNU}
	\subtitle{Demo of the  \texttt{horizontal} style in dark mode}
	\author{Ronny Bergmann}
	\date{\today}
\begin{document}
	\maketitle
    \begin{frame}[fragile]{A slide in \texttt{horizontal} style and dark mode}
        This style is set up with

        \lstinline!\usetheme[slogan=norsk, style=horizontal, mode=dark]{NTNU}!
