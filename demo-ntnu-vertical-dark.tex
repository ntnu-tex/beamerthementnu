...
\usetheme[style=vertical, frametotal=false, mode=dark]{NTNU}
%
% Edit your meta data here
%
	\title{\LaTeX{}-Beamer Style for NTNU}
	\subtitle{Demo of the  \texttt{vertical} style in dark mode}
...
\begin{document}
	\maketitle
		\begin{frame}[fragile]{A slide in \texttt{vertical} style}
			...
			\lstinline!\usetheme[style=vertical, frametotal=false, mode=dark]{NTNU}!
